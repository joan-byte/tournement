...
const loadMesa = async () => {
  try {
    ...
    // Si la mesa solo tiene una pareja (descansa)
    ...
    // Si ya existe un resultado, cargarlo
  ...
  try {
    ...
    const resultado = {
      pareja1: {
        ...
        partida_actual: mesa.value.campeonato_id, // Usamos el ID del campeonato como número de partida
